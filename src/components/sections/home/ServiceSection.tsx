    ...
    <>
      <section className="pt-12 sm:pt-16">
        <div className="container">
          <h3 className="text-blue-500 uppercase text-sm sm:text-lg text-center font-bold tracking-wide">{t('service-description')}</h3>
          <h2 className="text-blue-900 capitalize text-2xl sm:text-4xl text-center mt-2">{t('service-title')}</h2>
